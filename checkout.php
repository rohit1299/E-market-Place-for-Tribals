...
if(isset($_POST['submit'])){
	...
	if($payment_type=='instamojo'){
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER,
			array("X-Api-Key:test_52b6b3a588596a3b0f607862410","X-Auth-Token:test_82c344c94a10718b239d7d51158")
		);
		...
		$payload = Array(
			...
			'redirect_url' => 'http://localhost/ecommerce/payment_complete.php',
			'send_email' => true,
			'send_sms' => false,
			'email' => $userArr['email'],
